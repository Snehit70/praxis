...
async function main() {
  ...
  try {
    ...
    await insertInBatches(sql, 'options', ['id', 'question_id', 'option_text', 'option_image', 'score', 'is_correct', 'option_number', 'created_at', 'updated_at'], rows.options as object[], 2000);
